...
import { useYahooStocks, mockStocks, generatePriceHistory } from '@/utils/stocksApi';
import { StockCard } from '@/components/stocks/StockCard';
import { StockChart } from '@/components/stocks/StockChart';

const Stocks = () => {
  const liveSymbols = ['AAPL','MSFT','GOOGL','AMZN','NVDA','TSLA','META','V'];
  const liveStocks = useYahooStocks(liveSymbols, 10000);
  const stocks = liveStocks.length ? liveStocks : mockStocks;
